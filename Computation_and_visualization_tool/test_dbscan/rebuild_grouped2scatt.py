...
data_tensors = pd.read_csv("/Users/daggubatisirichandana/PycharmProjects/chart_percept/Topnvispaper/Grouped_bar2/tensor_vote_matrix.csv", sep=",", index_col=False)
...
# plt.axis('off')
# plt.suptitle("Redesigned scatter plot showing relation between two catogeries")
# plt.savefig('/Users/daggubatisirichandana/PycharmProjects/chart_percept/Topnvispaper/Grouped_bar2/Redesigned_scatter.png')

# # plot groups seperately
# plt.bar(groups_centers[:,1],height=groups_height[:,1],width=bin_width,bottom=base_y, color=[[0.2,0.2,0.2]])
# plt.axis('off')
# plt.suptitle("Plot of group2 bars seperately")
# plt.savefig('/Users/daggubatisirichandana/PycharmProjects/chart_percept/Topnvispaper/Grouped_bar2/Redesigned_bar_group2.png')
