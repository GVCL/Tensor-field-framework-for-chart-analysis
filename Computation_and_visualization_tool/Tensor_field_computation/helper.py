...
from Computation_and_visualization_tool.Text_DET_REC.Retrieve_Text import remove_text, remove_legend
...
def image_read(filename):
    ...
    compute_structure_tensor(data, image2, filename)  # compute structure tensor
