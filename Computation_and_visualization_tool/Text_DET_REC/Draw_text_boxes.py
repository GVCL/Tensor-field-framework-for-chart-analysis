...
img = cv2.imread("/Users/daggubatisirichandana/PycharmProjects/chart_percept/_Test/GroupedBar/gb3/gb03.png")
# canvas = cv2.imread("/Users/daggubatisirichandana/PycharmProjects/chart_percept/Computation_and_visualization_tool/Text_DET_REC/1.png")
...
detected_label,boxes,box_centers,_=detect_text(img)
label = text_recog()
centers=[]
...
# cv2.imwrite("/Users/daggubatisirichandana/PycharmProjects/chart_percept/_Test/GroupedBar/gb3/Text_gb03.png",dup_img)
