...
data_tensors = pd.read_csv("/home/komaldadhich/Documents/study/Research/graph_percept/source/project/chart_percept/Computation-and-visualization-tool/Tensor_field_computation/average_voting.csv", sep=",", index_col=False)
X = data_tensors['X']
Y = data_tensors['Y']
cl = data_tensors['CL']
