...
import numpy as np
import CRAFT_TextDetector.craft_utils
import CRAFT_TextDetector.imgproc
import CRAFT_TextDetector.file_utils
import json
import zipfile

from CRAFT_TextDetector.craft import CRAFT
...
parser.add_argument('--trained_model', default='CRAFT_TextDetector/craft_mlt_25k.pth', type=str, help='pretrained model')
...
def detect_text(image):
    ...
    # load data
    for root, dirs, files in os.walk("Deep_TextRecognition/Detected_Images/"):
        for file in files:
    ...
    for i, box in enumerate(bboxes):
        ...
        ime_name="Deep_TextRecognition/Detected_Images/"+str(i)+".png"
